...
shared.LoaderTitle = "SkibidiHub Free By Bao And Neo";
...
local v15 = v14:CreateWindow({
    Title = "SkibidiHub [ Free ] V1",
    SubTitle = "Please Join Discord",
    TabWidth = 160,
    Theme = "Light",
    Acrylic = false,
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=88079128897313";
v24.Parent = v23;
